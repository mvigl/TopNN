...
parser.add_argument('--filterlist', help='filterlist',default='/raven/u/mvigl/Stop/TopNN/data/H5/filter_sig_all.txt')#/raven/u/mvigl/Stop/TopNN/data/H5/filter_sig_FS.txt
